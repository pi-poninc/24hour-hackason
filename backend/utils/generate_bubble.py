...
def draw_speech_bubble_with_vertical_text(image, xy, text, font, color=(0, 0, 0), bubble_color=(255, 255, 255), line_spacing=5, max_chars_per_line=5):
    """
    ...
    # 吹き出しの尾（三角形）の描画
    triangle = [(bubble_right - 30, bubble_bottom), (bubble_right - 10, bubble_bottom), (bubble_right - 20, bubble_bottom + 30)]
